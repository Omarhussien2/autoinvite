  ...
  const faqs = [
    {
      ...
      a: "نعم، وهذا أولويتنا الأولى. يعتمد عزام على تقنية 'التمهل الذكي' التي تحاكي نمط الإرسال البشري الطبيعي بفواصل زمنية متغيرة ومدروسة، بدلاً من الإرسال الآلي المتسارع الذي يؤدي إلى الحظر. آلاف الحملات أُرسلت عبر منصتنا بأمان تام."
    },
    {
      q: "هل يمكنني إرسال دعوات شخصية باسم كل ضيف؟",
      a: "بالتأكيد. هذه إحدى أقوى ميزات عزام. ارفع ملف الأسماء، ضع التصميم الأساسي، وحدد مكان الاسم — وسيتولى النظام توليد كل دعوة باسم صاحبها وإرسالها تلقائياً. لا تكرار، لا أخطاء."
    },
    {
