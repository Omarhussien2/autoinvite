    ...
    <section className="py-32 px-6 md:px-12 lg:px-24 border-t border-zinc-800/50 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <p className="text-2xl text-zinc-400 mb-12 font-light">
          انضم للشركات التي تخلت عن العمل اليدوي.
        </p>
        
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          <button className="w-full sm:w-auto bg-digital-teal hover:bg-digital-teal-light text-bg-dark text-xl font-bold py-5 px-12 rounded-full transition-all hover:scale-105">
            اشترك الآن بـ 44 ريال
          </button>
          <span className="text-zinc-500">أو</span>
          <button className="w-full sm:w-auto bg-transparent border border-zinc-700 hover:border-zinc-500 text-zinc-300 text-xl font-medium py-5 px-12 rounded-full transition-all">
            تواصل مع المبيعات
          </button>
        </div>
      </div>
